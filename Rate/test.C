...
void test::Loop()
{
   ...
   int bit1 = 0x1;
   int bit2 = 0x1;
   TH1F *h1 = new TH1F("h1","Pt ratio distribution",100,0,1);
   ...
   //for (Long64_t jentry=0; jentry<5;jentry++) { //nentries
      ...
      for(int k=0; k<EgN; k++) {
        ...
        //if(fabs(EgEta) < 3.0 && EgEt > 8) EtaCutFlow = 1;
      }
...
//       else if(eta_region == 2) SetSingalBoundary(eta_region, EM_PiX_dphi_width_[nth_eg_pix_deta+1], EM_PiX_deta_width_[nth_eg_pix_deta+1], PiX_PiX_dphi_width_[nth_eg_pix_deta+1], PiX_PiX_deta_width_[nth_eg_pix_deta+1]);
       ...
       if(fabs(EgEta)>2.9 && fabs(EgEta)<3.0) SetSingalBoundary(eta_region, 0.02, EM_PiX_deta_width_[nth_eg_pix_deta+1]*2., 0.002,0.0025);
 //      if(fabs(EgEta)>2.9 && fabs(EgEta)<3.0) SetSingalBoundary(eta_region, EM_PiX_dphi_width_[nth_eg_pix_deta+1]*1., EM_PiX_deta_width_[nth_eg_pix_deta+1]*2., PiX_PiX_dphi_width_[nth_eg_pix_deta+1]*0.8, PiX_PiX_deta_width_[nth_eg_pix_deta+1]*1.0);
       // PixTRK algorithm 
       pass_count = 0;
...
//       if(fabs(EgEta)>2.9 && fabs(EgEta)<3.0) SetSingalBoundary(eta_region, EM_PiX_dphi_width_[nth_eg_pix_deta+1]*1.0, EM_PiX_deta_width_[nth_eg_pix_deta+1]*2., PiX_PiX_dphi_width_[nth_eg_pix_deta+1]*0.8, PiX_PiX_deta_width_[nth_eg_pix_deta+1]*1.);
       if(fabs(EgEta)>2.9 && fabs(EgEta)<3.0) SetSingalBoundary(eta_region, 0.02, EM_PiX_deta_width_[nth_eg_pix_deta+1]*2., 0.002,0.0025);
//       if(fabs(EgEta)>2.9 && fabs(EgEta)<3.0) SetSingalBoundary(eta_region, 0.03, EM_PiX_deta_width_[nth_eg_pix_deta+1]*2., 0.003,0.003);
       // PixTRK algorithm 
       pass_count = 0;
       pass_count_wo4thPix = 0, pass_count_wo3thPix = 0, pass_count_wo2thPix = 0, pass_count_wo1thPix = 0;
       woEM_pass_count_wo4thPix = 0, woEM_pass_count_wo3thPix = 0, woEM_pass_count_wo2thPix = 0, woEM_pass_count_wo1thPix = 0;
