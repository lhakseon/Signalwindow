...
// Fri Oct  5 13:24:04 2018 by ROOT version 6.13/08
// from TTree L1PiXTRKTree/L1PiXTRKTree
// found on file: SingleElectron_NoPU.root
//////////////////////////////////////////////////////////

#ifndef basic_study_h
#define basic_study_h
...
#ifdef basic_study_cxx
basic_study::basic_study(TTree *tree) : fChain(0) 
{
...
basic_study::~basic_study()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t basic_study::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t basic_study::LoadTree(Long64_t entry)
{
...
void basic_study::Init(TTree *tree)
{
...
void basic_study::Show(Long64_t entry)
{
...
Int_t basic_study::Cut(Long64_t entry)
{
